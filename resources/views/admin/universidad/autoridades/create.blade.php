...
@section('title', 'Crear Autoridad')

@section('page-title', 'Crear Autoridad Universitaria')
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <form action="{{ route('admin.universidad.autoridades.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save mr-1"></i> Guardar Autoridad
                        </button>
